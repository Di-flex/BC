...
let KinkyDungeonSpellList = { // List of spells you can unlock in the 3 books. When you plan to use a mystic seal, you get 3 spells to choose from.
	"Elements": [
		...
		{name: "BigBoulderLaunch", tags: ["earth", "bolt", "offense"], prerequisite: "BoulderLaunch", sfx: "Telekinesis", school: "Elements", manacost: 8, components: ["Legs"], projectileTargeting: true, noTargetPlayer: true, noEnemyCollision: true, CastInWalls: true, level:2, type:"inert", onhit:"aoe", time: 8, delay: 3, power: 20, range: 50, meleeOrigin: true, size: 1, lifetime: 1, damage: "inert",
		...
		{name: "Shield", tags: ["shield", "defense"], prerequisite: "ApprenticeEarth", sfx: "MagicSlash", school: "Elements", manacost: 2.5, components: ["Legs"], mustTarget: true, level:1, type:"buff",
			buffs: [
				{id: "Shield", type: "magicDamageResist", aura: "#73efe8", duration: 12, power: 0.67, player: false, enemies: true, tags: ["defense", "damageTaken"]},
