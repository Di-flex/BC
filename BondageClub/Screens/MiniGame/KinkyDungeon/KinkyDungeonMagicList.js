...
let KinkyDungeonSpellList = { // List of spells you can unlock in the 3 books. When you plan to use a mystic seal, you get 3 spells to choose from.
	"Elements": [
		...
		{name: "BigBoulderLaunch", tags: ["earth", "bolt", "offense"], prerequisite: "BoulderLaunch", sfx: "Telekinesis", school: "Elements", manacost: 5, components: ["Legs"], projectileTargeting: true, noTargetPlayer: true, noEnemyCollision: true, CastInWalls: true, level:2, type:"inert", onhit:"aoe", time: 8, delay: 3, power: 14, range: 50, meleeOrigin: true, size: 1, lifetime: 1, damage: "inert",
