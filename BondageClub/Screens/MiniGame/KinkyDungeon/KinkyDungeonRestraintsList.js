...
const KinkyDungeonRestraints = [
  ...
  //region Cosplay
	...
	{inventory: true, name: "AsylumJacket", Asset: "HighSecurityStraitJacket", Modules: [1, 1, 3], Color: ["#333", "#333", '#808080', '#808080'], LinkableBy: ["TransportJackets"], Group: "ItemArms", power: 9, weight: 0, bindarms: true, bindhands: true,strictness: 0.2,
	...
	{inventory: true, name: "TransportJacket", Asset: "TransportJacket", events: [{type: "PrisonerJacket", trigger: "afterDress"}], Color: ["#808080", "#202020", "#808080", "#EEE", "#202020", "#808080"], Group: "ItemArms", power: 9, weight: 0, bindarms: true, bindhands: true,strictness: 0.3,
		limitChance: {"Struggle": 0.12, "Cut": 0.03, "Remove": 0.1, "Unlock": 0.75}, // Hard to escape the arms box by struggling
		escapeChance: {"Struggle": -0.175, "Cut": 0.1, "Remove": 0.15, "Pick": 0.15},
    enemyTags: {"nurseRestraints": 5}, playerTags: {"ItemArmsFull":-2}, minLevel: 0, maxstamina: 0.30, allFloors: true, shrine: ["Straitjackets", "TransportJackets"]},

	{renderWhenLinked: ["Belts"], inventory: true, name: "AsylumLegbinder", Asset: "LegBinder", LinkableBy: ["Hobbleskirts", "Belts"], Color: "Default", Group: "ItemLegs", blockfeet: true, power: 6, weight: 2, escapeChance: {"Struggle": -0.1, "Cut": 0.1, "Remove": 0.35, "Pick": 0.25}, enemyTags: {"nurseRestraints": 5}, playerTags: {}, minLevel: 0, allFloors: true, shrine: ["Leather", "Legbinders"]},
	...
	{inventory: true, name: "AsylumAnkleCuffs", Asset: "LeatherAnkleCuffs", LinkableBy: ["Wrapping", "Ties", "Belts"], Link: "AsylumAnkleCuffs2", DefaultLock: "Blue", Type: "Chained", Color: ["Default", "#814F21", "#Default"], Group: "ItemFeet", hobble: true, power: 9, weight: 0,
		escapeChance: {"Struggle": -0.2, "Cut": -0.05, "Remove": 0.3, "Pick": 0.25}, enemyTags: {"nurseRestraints": 5, "nurseCuffRestraints": 5}, playerTags: {"ItemFeetFull":-2}, minLevel: 3, allFloors: true, shrine: ["Leather", "Cuffs", "AnkleCuffsBase"],
	...
	{name: "AsylumAnkleCuffs2", Asset: "LeatherAnkleCuffs", LinkableBy: ["Wrapping", "Ties", "Belts"], UnLink: "AsylumAnkleCuffs", Type: "Closed", Color: ["Default", "#814F21", "Default"], Group: "ItemFeet", blockfeet: true, power: 9, weight: 0,
		escapeChance: {"Struggle": -0.2, "Cut": -0.05, "Remove": 0.3, "Pick": 0.25}, enemyTags: {"nurseRestraints": 5, "nurseCuffRestraints": 5}, playerTags: {"ItemFeetFull":-2}, minLevel: 0, allFloors: true, shrine: ["Leather", "Cuffs"],
		events: [{trigger: "remove", type: "unlinkItem"}, {trigger: "postRemoval", type: "RequireBaseAnkleCuffs"}]},
	...
	{inventory: true, name: "AsylumMuzzle", gag: 1.0, Asset: "FuturisticMuzzle", Modules: [1, 1, 0], Group: "ItemMouth3", Color: ["#814F21","#814F21","#814F21","#814F21"], power: 8, weight: 2, escapeChance: {"Struggle": -0.1, "Cut": 0.18, "Remove": 0.4, "Pick": 0.2}, maxstamina: 0.9,
		enemyTags: {"nurseRestraints":1}, playerTags: {"ItemMouthFull":1}, minLevel: 0, allFloors: true, shrine: ["Leather", "Gags"]},
