...
let KinkyDungeonEnemies = [
	...
	{name: "Necromancer", faction: "Witch", clusterWith: "skeleton", bound: "Necromancer", playLine: "Necromancer", tags: KDMapInit(["leashing", "opendoors", "closedoors", "human", "witch", "ranged", "slimeRestraints", "miniboss", "unflinching", "meleeweakness", "hunter"]), followRange: 1, cohesion: 0.9,
		...
		terrainTags: {"secondhalf":3, "lastthird":3, "miniboss": -7}, shrines: [], floors:KDMapInit(["cat", "jng", "tmb"]),
	...
	{name: "Librarian", clusterWith: "construct", bound: "Dressmaker", playLine: "Dressmaker", faction: "Dressmaker", color: "#f135a4", tags: KDMapInit(["leashing", "miniboss", "acidweakness", "conjurer", "opendoors", "closedoors", "human", "ranged", "unflinching", "hunter", "magicRibbons"]),
		...
		spellCooldownMult: 0.7, spellCooldownMod: 0, AI: "hunt", guardChance: 0.4, visionRadius: 7, maxhp: 8, spellResist: 0.35, minLevel:0, weight: -12, movePoints: 2, attackPoints: 2, attack: "SpellMeleeBindWillLock", projectileTargeting: true,
		attackWidth: 1, attackRange: 1, power: 3, dmgType: "grope", fullBoundBonus: 3, focusPlayer: true,
