...
let KinkyDungeonEnemies = [
	...
	{name: "DragonShield", clusterWith: "dragon", bound: "Dragon", color: "#F92900", tags: KDMapInit(["opendoors", "fire", "leashing", "dragon", "melee", "dragonRestraints", "handcuffer", "leatherRestraints", "fireresist", "jail", "search"]), cohesion: 0.75,
		...
		visionRadius: 8, maxhp: 14, minLevel:7, weight:-1, movePoints: 2, attackPoints: 2, attack: "MeleeBindWill", attackWidth: 3, attackRange: 1, tilesMinRange: 1, power: 3, dmgType: "grope", fullBoundBonus: 1,
		...
		dropTable: [{name: "Gold", amountMin: 10, amountMax: 20, weight: 12}, {name: "Pick", weight: 3}, {name: "PotionStamina", weight: 1}]},
