...
let KinkyDungeonEnemies = [
	...
	{name: "AllyDoll", bound: "AllyDoll", color: "#9c2a70", tags: KDMapInit(["human", "player", "melee", "glueimmune", "ticklesevereweakness", "nohelp"]), allied: true, armor: 0, followRange: 1, AI: "hunt",
		visionRadius: 20, playerBlindSight: 100, maxhp: 10, regen: 0.05, minLevel:0, weight:0, movePoints: 2, attackPoints: 2, attack: "MeleeWill", attackRange: 1, attackWidth: 1, power: 1.5, dmgType: "glue",
		terrainTags: {}, floors:KDMapInit([])},
	...
	{name: "BanditChief", faction: "Bandit", clusterWith: "bandit", playLine: "Bandit", bound: "BanditChief", tags: KDMapInit(["opendoors", "cacheguard", "closedoors", "leashing", "bandit", "miniboss", "banditleader", "melee", "unflinching", "ballGagRestraints", "handcuffer", "leatherRestraints", "leatherRestraintsHeavy", "clothRestraints", "chainweakness", "glueweakness", "jail", "hunter"]), cohesion: 0.9, armor: 0, followRange: 1, AI: "hunt",
		...
		terrainTags: {"secondhalf":16, "lastthird":5, "open": 10, "passage": -10, "increasingWeight":1}, shrines: ["Leather"], floors:KDMapInit(["jng", "cry"]),
	...
	{name: "ElementalIce", faction: "Elemental", playLine: "Elemental", clusterWith: "ice", bound: "ElementalIce", color: "#aaaaff", tags: KDMapInit(["opendoors", "elemental", "ice", "ranged", "firesevereweakness", "crushweakness", "coldresist", "iceimmune", "iceRestraints", "leashing", "search"]),
		...
		terrainTags: {"secondhalf":1, "thirdhalf":1, "open": 1, "elementsAnger": 8, "elementsRage": 3, "temple": 3}, allFloors: true, shrines: ["Elements"], attackLock: "Purple",
	...
	{name: "ElfRanger", faction: "Elf", clusterWith: "nature", bound: "ElfRanger", playLine: "Elf", color: "#67ff44", tags: KDMapInit(["opendoors", "leashing", "nature", "elf", "ranged", "elite", "mithrilRope", "pierceweakness", "iceweakness", "chainresist", "hunter"]), cohesion: 0.0,
		...
		visionRadius: 9, maxhp: 12, minLevel:7, weight:-1, movePoints: 1, attackPoints: 3, attack: "SpellMeleeWillBind", attackWidth: 3, attackRange: 1, tilesMinRange: 1, power: 2, dmgType: "grope", fullBoundBonus: 2,
	...
	{name: "Elf", faction: "Elf", clusterWith: "elf", bound: "Elf", playLine: "Elf", color: "#67ff44", tags: KDMapInit(["opendoors", "leashing", "elf", "imprisonable", "nature", "ranged", "elite", "mithrilRestraints", "pierceweakness", "iceweakness", "chainresist", "hunter"]), cohesion: 0.7,
		...
		visionRadius: 9, maxhp: 15, minLevel:4, weight:-3, movePoints: 2, attackPoints: 3, attack: "SpellMeleeWillBind", attackWidth: 3, attackRange: 1, tilesMinRange: 1, power: 2, dmgType: "grope", fullBoundBonus: 2,
		terrainTags: {"secondhalf":1, "thirdhalf":1, "willAnger": 4, "willRage": 6}, shrines: ["Will"], allFloors: true,
	...
	{name: "Necromancer", faction: "Witch", clusterWith: "skeleton", bound: "Necromancer", playLine: "Necromancer", tags: KDMapInit(["leashing", "opendoors", "closedoors", "human", "witch", "ranged", "slimeRestraints", "miniboss", "unflinching", "meleeweakness", "hunter"]), followRange: 1, cohesion: 0.9,
		...
		terrainTags: {"secondhalf":3, "lastthird":3, "miniboss": -7}, shrines: [], floors:KDMapInit(["cat", "jng", "tmb"]), attackLock: "Red",
