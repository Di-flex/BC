...
let KinkyDungeonEnemies = [
	...
	{name: "Golem", tags: KDMapInit(["construct", "player", "melee", "fireresist", "unstoppable", "tickleresist", "groperesist", "electricresist", "charmimmune"]), keepLevel: true, allied: true, armor: 2.5, spellResist: 0.4, followRange: 1, AI: "hunt",
		...
		terrainTags: {}, floors:KDMapInit([])},
	{name: "StormCrystal", tags: KDMapInit(["construct", "player", "ranged", "unstoppable", "meleeresist", "tickleimmune", "electricimmune", "temporary", "notalk"]), immobile: true, noblockplayer: true, allied: true, armor: 2, followRange: 1, AI: "wander", evasion: -10,
