...
let KinkyDungeonEnemies = [
	...
	{name: "Ally", tags: KDMapInit(["ghost", "player", "melee"]), keepLevel: true, noblockplayer: true, allied: true, armor: 0, followRange: 1, AI: "hunt", evasion: 0.33, accuracy: 1.5,
		...
		terrainTags: {}, floors:KDMapInit([])},
	{name: "AllyDoll", bound: "AllyDoll", color: "#9c2a70", tags: KDMapInit(["human", "player", "melee", "glueimmune", "ticklesevereweakness", "nohelp"]), noblockplayer: true, allied: true, armor: 0, followRange: 1, AI: "hunt",
	...
	{name: "ShadowWarrior", tags: KDMapInit(["ghost", "player", "melee", "tickleimmune", "glueimmune"]), noblockplayer: true, allied: true, armor: 0, followRange: 1, AI: "hunt", evasion: 1,
		...
		terrainTags: {}, floors:KDMapInit([])},
	{name: "FireElemental", bound: "ElementalFire", color: "#FF6200", tags: KDMapInit(["construct", "player", "ranged", "fireimmune", "coldweakness", "icesevereweakness", "nohelp"]), keepLevel: true, noblockplayer: true, allied: true, armor: 0, kite: 1.5, followRange: 3, playerFollowRange: 1, AI: "hunt",
