		...
		for (let enemy of KinkyDungeonEntities) {
			if ((b.reflected
				|| (!b.bullet.spell || !b.bullet.faction
					|| (KDFactionHostile(b.bullet.faction, KDGetFaction(enemy)) && (!b.bullet.damage || b.bullet.damage.type != "heal"))
					|| (KDFactionAllied(b.bullet.faction, KDGetFaction(enemy)) && (b.bullet.damage && b.bullet.damage.type == "heal"))
				))
				...
				for (let enemy of KinkyDungeonEntities) {
					if ((bullet.reflected
						|| (!bullet.bullet.spell || !bullet.bullet.faction
							|| (KDFactionHostile(bullet.bullet.faction, KDGetFaction(enemy)) && (!bullet.bullet.damage || bullet.bullet.damage.type != "heal"))
							|| (KDFactionAllied(bullet.bullet.faction, KDGetFaction(enemy)) && (bullet.bullet.damage && bullet.bullet.damage.type == "heal"))
						))
